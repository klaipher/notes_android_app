package com.example.project.fragments.listFragment
...
import com.example.project.adapter.NoteClickListener
...
class ListFragment : Fragment() , NoteClickListener {
    ...
    override fun onCreateView(
        ...
        noteViewModel.readAllData.observe(viewLifecycleOwner
            ...
            val adapter = com.example.project.adapter.ListAdapter(note, this)
    ...
    override fun clickListener(position : Note) {
    ...
    private fun deleteNotes(){
        ...
        builder.setPositiveButton("Yes!" ){ _ , _ ->
            ...
            Toast.makeText(requireContext(),"Wiped!",Toast.LENGTH_SHORT).show()
